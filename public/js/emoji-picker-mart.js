...
(() => {
/*!*******************************************!*\
  !*** ./resources/js/emoji-picker-mart.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var emoji_mart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! emoji-mart */ "./node_modules/emoji-mart/dist/module.js");
/* harmony import */ var _emoji_mart_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @emoji-mart/data */ "./node_modules/@emoji-mart/data/sets/15/native.json");
function _typeof(o) {
...
var EmojiPickerMart = /*#__PURE__*/function () {
  function EmojiPickerMart() {
    _classCallCheck(this, EmojiPickerMart);
    this.picker = null;
    this.container = null;
    this.isVisible = false;
    this.targetInput = null;
  }
  return _createClass(EmojiPickerMart, [{
    key: "initialize",
    value: function () {
      var _initialize = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              containerId = _args.length > 0 && _args[0] !== undefined ? _args[0] : 'emojiPickerContainer';
            ...
            case 1:
              ...
              this.picker = new emoji_mart__WEBPACK_IMPORTED_MODULE_0__.Picker({
                data: _emoji_mart_data__WEBPACK_IMPORTED_MODULE_1__,
                onEmojiSelect: function onEmojiSelect(emoji) {
                  return _this.handleEmojiSelect(emoji);
                },
                theme: 'light',
                ...
                navPosition: 'bottom',
                categories: ['frequent', 'people', 'nature', 'foods', 'activity', 'travel', 'objects', 'symbols', 'flags']
              });
            ...
            case 3:
              _context.p = 3;
              _t = _context.v;
              console.error('Failed to initialize emoji picker:', _t);
    ...
    key: "createFallbackPicker",
    value: function createFallbackPicker() {
      var _this2 = this;
      ...
      emojis.forEach(function (emoji) {
        ...
        button.onmouseover = function () {
          return button.style.backgroundColor = '#f0f0f0';
        };
        button.onmouseout = function () {
          return button.style.backgroundColor = 'transparent';
        };
        button.onclick = function () {
          return _this2.handleEmojiSelect({
            "native": emoji
          });
        };
    ...
    value: function handleEmojiSelect(emoji) {
      var emojiChar = emoji["native"] || emoji.emoji || emoji;
      if (this.targetInput) {
    ...
    key: "insertEmojiIntoInput",
    value: function insertEmojiIntoInput(input, emoji) {
      var start = input.selectionStart || 0;
      var end = input.selectionEnd || 0;
      var value = input.value || '';
      var newValue = value.slice(0, start) + emoji + value.slice(end);
      ...
      if (window.Livewire) {
        var _input$closest;
        var component = window.Livewire.find((_input$closest = input.closest('[wire\\:id]')) === null || _input$closest === void 0 ? void 0 : _input$closest.getAttribute('wire:id'));
        if (component) {
    ...
    key: "show",
    value: function show() {
      var targetInput = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (EmojiPickerMart);
})();

/******/ })()
;
//# sourceMappingURL=emoji-picker-mart.js.map